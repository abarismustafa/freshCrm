...
import DeliveryList from '../../../../components/FoodsBhojan/Report/Report-subsub/DeliveryList'

function DeliveryTypeSell() {
  return (
    <div>
    <div className="card" style={{ marginTop: "10px", marginLeft: "4px", marginRight: "4px" }}>
      <div className="table-responsive active-projects style-1">
        <h3 className="tbl-caption text-light">
     Sell Report Delivery Type
          <div>
             </div>
          </h3></div>
          <div class="row">
...
export default DeliveryTypeSell

...
import ServiceChargesList from '../../../../components/FoodsBhojan/Report/Report-subsub/ServiceChargesList'
...
function ServiceCharges() {
  return (
    ...
    <form class="d-flex align-items-center gap-2 row">
     ...
     <div className='col-lg-3 col-md-6 col-12'>
      <label for="to" class="form-label mb-0">Invoice No</label>

...
import StockReportWiseList from '../../../components/FoodsBhojan/Report/StockReportWiseList'

function StockReportProductWise() {
  return (
    <div>
    ...
    <form class="d-flex align-items-center gap-2 row">
      ...
      <label for="from" class="form-label mb-0">Food Name</label>

...
export default function LoanrepotList() {
    const item = true
    return (
                ...
                <div className="card mt-4">
                    <div className="table-responsive active-projects style-1">
                        ...
                        <div className="row m-2">
                            <div className="col-3">
                                <input className="form-control" placeholder="Enter Your Employee ID" />
                            </div>
                            <div className="col-3">
                            ...
                            <div className="col-2">
                                <button className="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i> Filter</button>
                            </div>
                        </div>
                    </div>
                </div>

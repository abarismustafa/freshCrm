...
export default function GrandLoanList(){
    const item = true
    return (
            ...
            <div className="card mt-4">
                <div className="table-responsive active-projects style-1">
                    <div className="tbl-caption">
                        ...
                        <div>
                            <Link className="btn btn-primary btn-sm m-1" to="/addgrandloan"  role="button" aria-controls="offcanvasExample"><i class="fa-solid fa-plus"></i> Add Loan</Link>
                            <Link className="btn btn-primary btn-sm m-1"  role="button" aria-controls="offcanvasExample">Manage Grand Loan</Link>
                        </div>
                    </div>
                </div>
            </div>
